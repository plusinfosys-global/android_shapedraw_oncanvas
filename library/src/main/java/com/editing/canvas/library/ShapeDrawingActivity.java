...
public class ShapeDrawingActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        mDrawingView = findViewById(R.id.drawingViewAll);

        relativeLayoutMain = findViewById(R.id.relativeMain);
        layoutAllShapeInclude = findViewById(R.id.bottomLayoutAllSizeShapes);
        mainFrameLayout = findViewById(R.id.wholeFrameLayout);
        imgClearAllDrawing = findViewById(R.id.txtClear);
        imgUndo = findViewById(R.id.txtUndo);
        layoutShapeClick = findViewById(R.id.layoutShapeClick);
        linearLayoutCircles = findViewById(R.id.linearLayoutCircles);
        ...
        txtCircleBorderWidth = findViewById(R.id.txtShape1SCircleWidth);
        linearLayoutSquare = findViewById(R.id.linearLayoutSquares);
        ...
        txtSquareBorderWidth = findViewById(R.id.txtShape1SquareWidth);
        txtSquareRoundedBorderWidth = findViewById(R.id.txtShape2SquareCornerRad);
        linearLayoutLines = findViewById(R.id.linearLayoutLines);
        ...
        txtLineWidth = findViewById(R.id.txtShape1LineRadius);
        imgCloseScreen = findViewById(R.id.txtClose);
        imgsave = findViewById(R.id.txtSave);
        linearLayoutPensil = findViewById(R.id.linearLayoutpensils);
    ...
    private void initializeAllViews() {
       ...
       // popupWindow.setHeight(height-(height*4));
            ...
            public void onClick(View view) {
                if (popupWindow != null && popupWindow.isShowing()) {
                    ...
                    if (!Helper.isLandscapeScreen(getApplicationContext()))
                        popupWindow.showAsDropDown(layoutShapeClick, 15, (height * -90)/720);
                    else
